...
let finalPrice = document.getElementById("btn");
finalPrice.addEventListener("click", getValue);
finalPrice.addEventListener("click", getSelectedOption);
finalPrice.addEventListener("click", getPrice);
